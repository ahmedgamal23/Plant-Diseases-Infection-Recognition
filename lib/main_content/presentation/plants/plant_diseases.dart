...
import 'package:plant_infection_recognition/main_content/presentation/plants/real_time_detection.dart';
...
class _PlantDiseasesState extends State<PlantDiseases> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: _showAppBar
          ? AppBar(
        title: const Text("Plants Detection"),
        backgroundColor: ConstantColor.mainContentBgColor,
        actions: const [
          Padding(
  ...
  Widget imageDetection() {
    return const ImageDetection();
  }

  Widget detectImages() {
    return const RealTimeDetection();
  }
